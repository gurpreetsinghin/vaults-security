            ...
            <div class="col-md-12">
                <div class="card card-dark">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('ps.admin.ip-ban.delete', $common->getBannedId($log->ip)) }}" class="btn btn-flat btn-success"><i class="fas fa-ban"></i> Unban</a>
                        @else
                        <a href="{{ route('ps.admin.ip-ban') }}" class="btn btn-flat btn-warning"><i class="fas fa-ban"></i> Ban</a>
                        @endif
