...
<div class="content-header">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-align-justify"></i> Badbot Logs</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('ps.admin.dashboard') }}"><i class="fas fa-home"></i> Admin Panel</a></li>
                    <li class="breadcrumb-item active">Badbot Logs</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title">Badbot Logs</h3>
                    </div>
                    <div class="card-body">
                        <center><a href="{{ route('ps.admin.badbot-logs.delete-all') }}" class="btn btn-flat btn-danger" title="Delete all logs"><i
                        ...
                        <table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="{{ route('ps.admin.badbot-logs.unban-ip', $log->ip) }}" class="btn btn-flat btn-success"><i class="fas fa-ban"></i> Unban</a>
                                    @else
                                    <a href="{{ route('ps.admin.badbot-logs.ban-ip', $log->ip) }}" class="btn btn-flat btn-warning"><i class="fas fa-ban"></i> Ban</a>
                                    @endif
                                    <a href="{{ route('ps.admin.badbot-logs.delete', $log->id) }}" class="btn btn-flat btn-danger"><i class="fas fa-times"></i> Delete</a>
                                    <a href="{{ route('ps.admin.badbot-logs.view', $log->id) }}" class="btn btn-flat btn-primary"><i class="fas fa-tasks"></i> Details</a>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
