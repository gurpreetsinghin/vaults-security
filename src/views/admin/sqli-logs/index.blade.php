        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <center><a href="{{ route('ps.admin.sqli-logs.delete-all') }}" class="btn btn-flat btn-danger" title="Delete all logs"><i
                        ...
                        <table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="{{ route('ps.admin.sqli-logs.view', $log->id) }}" class="btn btn-flat btn-primary"><i class="fas fa-tasks"></i> Details</a>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
