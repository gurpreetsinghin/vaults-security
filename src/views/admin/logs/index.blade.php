...
<div class="content-header">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-align-justify"></i> All Logs</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <center><a href="{{ route('ps.admin.logs.delete-all') }}" class="btn btn-flat btn-danger" title="Delete all logs"><i
                        ...
                        <table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="{{ route('ps.admin.unban-ip', $log->ip) }}" class="btn btn-flat btn-success"><i class="fas fa-ban"></i> Unban</a>
                                    @else
                                    <a href="{{ route('ps.admin.ban-ip', $log->ip) }}" class="btn btn-flat btn-warning"><i class="fas fa-ban"></i> Ban</a>
                                    @endif
                                    <a href="{{ route('ps.admin.logs.delete', $log->id) }}" class="btn btn-flat btn-danger"><i class="fas fa-times"></i> Delete</a>
                                    <a href="{{ route('ps.admin.view', $log->id) }}" class="btn btn-flat btn-primary"><i class="fas fa-tasks"></i> Details</a>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
